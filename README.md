...
- [Что такое \_\_slots\_\_. Плюсы, минусы](#что-такое-__slots__-плюсы-минусы)
- [В чем смысл параметров _value, __value](#в-чем-смысл-параметров-_value-__value)
- [Что такое \_\_new\_\_. И чем он отличается от \_\_init\_\_. В какой последовательности они выполняются](#что-такое-__new__-и-чем-он-отличается-от-__init__-в-какой-последовательности-они-выполняются)
...
## [Что такое select_related и prefetch_related](#что-такое-select_related-и-prefetch_related)
